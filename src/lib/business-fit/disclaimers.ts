...
export const PHASE1_ASSUMPTIONS = [
  "Facility build-out complexity follows typical U.S. food-service patterns for the selected concept class.",
  "Equipment needs follow standard category checklists and are not vendor-quoted prices.",
  "Opening timeline assumes ordinary municipal review cycles and does not model a specific jurisdiction.",
  "Investment budget is treated as total available capital before financing structure is defined.",
  "Owner experience reduces operational ramp risk in the model but does not replace local due diligence.",
] as const;
